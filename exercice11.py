...
def handle_collisions(ball, other_sprite):
    ...
    if ball.x+ball.width >= other_sprite.x and \
       ball.x <= other_sprite.x + other_sprite.width and \
       ball.y+ball.height >= other_sprite.y and \
       ball.y <= other_sprite.y+other_sprite.height:
        print("collision")

        if ball.directionY > 0 and ball.y+ball.height >= other_sprite.y:  # if up and collision
            ball.directionY = -ball.directionY
            ball.y = other_sprite.y-ball.height
            return

        if ball.directionY < 0 and ball.y <= other_sprite.y+other_sprite.height:
            ball.directionY = -ball.directionY
            ball.y = other_sprite.y+other_sprite.height
            return

        if ball.directionX < 0 and ball.x <= other_sprite.x + other_sprite.width:
            ball.directionX = -ball.directionX
            ball.x = other_sprite.x
            return

        if ball.directionX > 0 and ball.x+ball.width >= other_sprite.x:
            ball.directionX = -ball.directionX
            ball.x = other_sprite.x-ball.width
            return
